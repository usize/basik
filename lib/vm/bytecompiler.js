...
ByteCompiler.prototype = {
  ...
  compileStatement(stmt) {
    ...
    for (let cmd of stmt.commands) {
      ...
      case "DimAssign":
        ...
        this.compileExpr(cmd.innerExpr)
  ...
  load(variable) {
    if (variable.dataType == "string")
      ...
      this.emit("loadarray", this.arrays.get(variable.name.value));
     else
  ...
  store(variable) {
    if (variable.dataType == "string")
      ...
      this.emit("createarray", this.arrays.get(variable.name));
    else
